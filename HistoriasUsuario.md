...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="border-style:solid;border-width:1px;text-align:center;vertical-align:middle" rowspan="1"><ol><li>Ao entrar no aplicativo deve aparacer uma janela com opções para adicionar remedios ou ver agenda com remedios adicionados</li><li> A tela do vídeo deve estar maximizada na tela do celular</li><li>Os vídeos devem aparecer em sequência</li></ol></td>
